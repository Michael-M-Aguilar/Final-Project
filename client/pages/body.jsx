  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      <div className="container desktop-body">
        ...
        <div className="row">
          <div className="desktop-secondary border border-dark border-3 rounded col-md-4 col-sm-12">
          ...
          <div className="desktop-secondary border border-dark border-3 rounded col-md-4 col-sm-12 flex justify-content-center align-items-center">
                  ...
                  : info.slice(0, 4).map(key => (
                    <div key={key.entryId} className="flex space-between border-top border-2 py-1 rt">
                      ...
                      <div className="flex flex-column">
                        ...
                        <p className="fs-5 dm-text raleway text-end">{(!key) ? '...' : moment(key.date).format('MMM Do YYYY')}</p>
                      </div>
                    </div>
                  ))
            }
